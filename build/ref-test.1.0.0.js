...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container = function (_React$Component) {
	  ...
	  _createClass(Container, [{
	    ...
	    value: function onButtonClick(evt) {
	      evt.preventDefault();
	      var form = _reactDom2.default.findDOMNode(this.refs.inputForm.textInput);
	      var item = form.value;
	...
	var InputWithButton = function (_React$Component2) {
	  _inherits(InputWithButton, _React$Component2);
	
	  function InputWithButton(props) {
	    _classCallCheck(this, InputWithButton);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(InputWithButton).call(this, props));
	  }
	
	  _createClass(InputWithButton, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'submit', onClick: this.props.onClick })
	        )
	      );
	    }
	  }]);
